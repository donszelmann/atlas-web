...
?>
    ...
    <div id="mainWp">
    	<div id="content" class="container">
        	...
        	<div class="<?=$classlastest_news;?>">
				...
				<h3><a href="#" rel="toggle[rabbit_latestnews]" data-openimage="images/minus_arrow.png" data-closedimage="images/plus_arrow.png" style="text-decoration:none; color:#FFFFFF">Latest News<span style="margin-left:494px;"><img src="images/minus_arrow.png" border="0" style="padding-top:3px"/></span></a></h3>
                ...
                <div class="subBox" id="rabbit_latestnews">
                	<div class="lastest_ltCol">
                    	<div class="generalNews">
                            ...
                            <div class="insideBox">              
								...
								?>
								<h6 style="padding:2px 0px 2px 0px; text-decoration:none; font-size:11px; text-align:right;"><a href="http://cdsweb.cern.ch/search?cc=ATLAS%20Live%20General%20News" target="_blank">All General News</a></h6>
                        ...
                        <div class="generalNews">
                        	<div class="tiggertitle">trigger</div>                          
                                <div class="insideBox">  
								<?php
								include_once("triggerreadxml.php");
								?>             
                                 <h6 style="padding:2px 10px 2px 0px; text-decoration:none; font-size:11px; text-align:right;"><a href="http://cdsweb.cern.ch/search?cc=ATLAS%20Live%20Trigger%20News" target="_blank">All Trigger News</a></h6>    
                                    
                          </div>
                      </div><!--end trigger-->	
                        <div class="generalNews">
                        	<div class="physictitle">Physics</div>                          
                            <div class="insideBox">  
							<?php
								include_once("physicsrealxml.php");
								?>  
								<h6 style="padding:2px 10px 2px 0px; text-decoration:none; font-size:11px; text-align:right;"><a href="http://cdsweb.cern.ch/search?cc=ATLAS%20Live%20Physics%20News" target="_blank">All Physics News</a></h6>            
                    ...
                    <div class="lastest_rtCol">
                        <div class="generalNews">
                                <div class="detectortitle">detector operation </div>                          
                                <div class="insideBox">              
	...
	document.write(todayStr);
							  ...
							  <div class="generalNews">
                                <div class="computingtitle">computing & software</div>                          
                            <div class="insideBox">          
							<?php
                              ...
                              <h6 class="last-child">Data collected until yesterday 4 pm reconstructed: worldwide distribution completed</h6>-->
                                <h6 style="padding:2px 10px 2px 0px; text-decoration:none; font-size:11px; text-align:right;"><a href="http://cdsweb.cern.ch/search?cc=ATLAS%20Live%20Computing%20%26%20Software%20News" target="_blank">All Computing & Software News</a></h6>
                          </div>
                        </div><!--end computing and Software-->
					  
                        <div class="generalNews">
                                <div class="datatitle">data preparation</div>                          
                                <div class="insideBox">              
                                 <?php
								include_once("datapreparationreadxml.php");
								?>
                                    <h6 style="padding:2px 10px 2px 0px; text-decoration:none; font-size:11px; text-align:right;"><a href="http://cdsweb.cern.ch/search?cc=ATLAS%20Live%20Data%20Preparation%20News" target="_blank">All Data Preparation News</a></h6>    
                          </div>
            ...
            <div class="<?=$classwebcast?>">
				...
				<h3><a href="#" rel="toggle[rabbit_webcasts]" data-openimage="images/minus_arrow.png" data-closedimage="images/plus_arrow.png" style="text-decoration:none; color:#FFFFFF">Webcast<span style="margin-left:187px;"><img src="images/minus_arrow.png" border="0" style="padding-top:3px"/></span></a></h3>
        ...
        <div class="clearfix"></div>
            ...
            <div class="subBox" id="rabbit_lhcoperation">
				...
				<img height="580" border="0" width="773" src="http://cs-ccr-www3.cern.ch/vistar_capture/lhc1.png"/>
            	
                </div>
                </div>
				<?php } ?>   
        </div><!--old link http://cs-ccr-www2.cern.ch/vistar_capture/lhc.png end lhc operation-->
            
		
       		<div class="<?=$classlarge_colBox?>">
        	<!--<h3>atlantis event display </h3> -->
			
			<h3><a href="#" rel="toggle[rabbit_atlantis]" data-openimage="images/minus_arrow.png" data-closedimage="images/plus_arrow.png" style="text-decoration:none; color:#FFFFFF">atlantis event display<span style="margin-left:727px;"><img src="images/minus_arrow.png" border="0" style="padding-top:3px"/></span></a></h3>
			<?php if($_SESSION['valid_code']!="") {?>    
